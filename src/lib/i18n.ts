...
const ko: Dict = {
  ...
  'onboarding.desc': '이 앱은 당신의 Google AI Studio(Gemini) API 키로 동작합니다. 키와 글귀·페르소나는 이 브라우저(localStorage/IndexedDB)에 저장되고, 분석·변환 시 입력 텍스트와 키는 Google Gemini API로 직접 전송됩니다.',
  ...
  // settings page
  'settings.subtitle': '데이터와 개인정보를 관리하세요.',
  'settings.dataTitle': '데이터 관리',
  'settings.dataDesc': '글귀와 페르소나를 백업·복원하거나 전체 삭제할 수 있어요.',
  'settings.exportBtn': '내보내기',
  'settings.importBtn': '가져오기',
  'settings.clearBtn': '전체 삭제',
  'settings.confirmClearAll': '모든 글귀·페르소나·API 키를 삭제할까요? 되돌릴 수 없습니다.',
  'settings.toastExported': '백업을 내보냈습니다.',
  'settings.toastExportFailed': '내보내기에 실패했습니다.',
  'settings.toastImported': '글귀 {phrases}개, 페르소나 {persona}개를 가져왔습니다.',
  'settings.toastImportFailed': '가져오기에 실패했습니다.',
  'settings.toastCleared': '모든 데이터를 삭제했습니다.',
  'settings.toastClearFailed': '삭제에 실패했습니다.',
  'settings.privacyTitle': '개인정보 및 보안',
  'settings.privacyDesc': 'Wordrobe는 이 브라우저에서만 동작합니다.',
  'settings.privacyLocal': '글귀·페르소나·API 키는 이 브라우저(IndexedDB/localStorage)에만 저장됩니다.',
  'settings.privacyGemini': '분석·변환 시 입력 텍스트와 키는 Google Gemini API로 직접 전송됩니다.',
  'settings.privacyKey': 'API 키는 우리 서버로 전송되지 않으며 Gemini 호출에만 사용됩니다.',
  'settings.privacyLoss': '브라우저 데이터를 지우거나 기기를 바꾸면 복구할 수 없습니다.',
  'settings.privacyConsent': '정기적으로 백업을 내보내 안전하게 보관하세요.',
  'settings.disclaimerTitle': '참고',
  'settings.disclaimerDesc': 'AI가 생성한 결과는 참고용입니다. 항상 직접 확인하세요.',
  'settings.analysisTitle': '페르소나 분석',
  'settings.analysisDesc': '글귀로 페르소나를 만드는 방식을 조절하세요.',
  'settings.autoAnalyzeTitle': '자동 분석',
  'settings.autoAnalyzeDesc': '글귀를 추가하면 페르소나를 자동으로 갱신합니다.',
  'settings.minPhrasesTitle': '분석 최소 글귀 수',
  'settings.minPhrasesDesc': '이 개수 이상 모이면 분석을 시작합니다.',
  'settings.languageTitle': '출력 언어',
...
const en: Dict = {
  ...
  'onboarding.desc': 'This app runs on your own Google AI Studio (Gemini) API key. Your key, phrases, and persona are stored in this browser (localStorage/IndexedDB), and your input text and key are sent directly to the Google Gemini API when analyzing or composing.',
  'onboarding.keyLabel': 'Gemini API Key',
  ...
  // settings page
  'settings.subtitle': 'Manage your data and privacy.',
  'settings.dataTitle': 'Data management',
  'settings.dataDesc': 'Back up, restore, or wipe your phrases and persona.',
  'settings.exportBtn': 'Export',
  'settings.importBtn': 'Import',
  'settings.clearBtn': 'Delete all',
  'settings.confirmClearAll': 'Delete all phrases, persona, and your API key? This cannot be undone.',
  'settings.toastExported': 'Backup exported.',
  'settings.toastExportFailed': 'Export failed.',
  'settings.toastImported': 'Imported {phrases} phrases and {persona} persona.',
  'settings.toastImportFailed': 'Import failed.',
  'settings.toastCleared': 'All data deleted.',
  'settings.toastClearFailed': 'Failed to delete data.',
  'settings.privacyTitle': 'Privacy & security',
  'settings.privacyDesc': 'Wordrobe runs entirely in this browser.',
  'settings.privacyLocal': 'Your phrases, persona, and API key are stored only in this browser (IndexedDB/localStorage).',
  'settings.privacyGemini': 'When analyzing or composing, your input text and key are sent directly to the Google Gemini API.',
  'settings.privacyKey': 'Your API key is never sent to our servers and is used only for Gemini calls.',
  'settings.privacyLoss': 'If you clear browser data or switch devices, your data cannot be recovered.',
  'settings.privacyConsent': 'Export a backup regularly to keep your data safe.',
  'settings.disclaimerTitle': 'Note',
  'settings.disclaimerDesc': 'AI-generated results are for reference only. Always review them yourself.',
  'settings.analysisTitle': 'Persona analysis',
  'settings.analysisDesc': 'Control how your persona is built from phrases.',
  'settings.autoAnalyzeTitle': 'Auto-analyze',
  'settings.autoAnalyzeDesc': 'Automatically refresh your persona when you add phrases.',
  'settings.minPhrasesTitle': 'Minimum phrases to analyze',
  'settings.minPhrasesDesc': 'Analysis starts once you have at least this many.',
  'settings.languageTitle': 'Output language',
